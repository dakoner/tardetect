...
if __name__ == '__main__':
    ...
    pipeline_config = os.path.join("z:/src/tensorflow/models/research/object_detection/configs/tf2", model_name + '.config')
    ...
    image_dir = 'c:/users/dek/tensorflow/models/research/object_detection/test_images'
